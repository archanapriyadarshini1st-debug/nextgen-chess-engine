...
int main() {
    std::vector<PerftTest> tests = {
        ...
        {"r4rk1/1pp1qppp/p1pb4/2p5/2Pp4/2P2N2/PP1Q1PPP/R1B1R1K1 w - - 0 1", {14,438,20985}, "pos6 - pins"},
        ...
        {"rnbqkbnr/ppp1pppp/8/3pP3/8/8/PPPP1PPP/RNBQKBNR b KQkq e6 0 1", {31}, "en passant e6"},
        {"rnbqkbnr/ppp1p1pp/8/3pPp2/8/8/PPPP1PPP/RNBQKBNR w KQkq f6 0 2", {38}, "en passant f6"},
    };
